...
from authapi.views import UserRegistrationView, UserLoginView,UserProfileView,ChangePasswordView,ResetPasswordEmailView, SaveNewPasswordView,ConfirmOTPView, RequestNewOTPView, ResetPasswordEmailView, GetUserByTokenView, CancleRegistrationView,ResetNameView, SetLoginIDView, UploadImageView
